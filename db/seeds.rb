Song.create!([
{title: "26-2", style: "Swing", composer: "John Coltrane"},
...
{title: "Ac-Cent-Tchu-Ate The Positive", style: "Swing", composer: "Harold Arlen"},
{title: "Across The Valley From The Alamo", style: "Swing", composer: "Joe Greene"},
...
{title: "Alexander's Ragtime Band", style: "Swing", composer: "Irving Berlin"},
...
{title: "All God's Chillun Got Rhythm", style: "Swing", composer: "KahnKaper"},
{title: "All My Tomorrows", style: "Ballad", composer: "Jimmy VanHeusen"},
{title: "All Of A Sudden My Heart Sings", style: "Ballad", composer: "HerpinJamblanRome"},
...
{title: "Almost Like Being In Love", style: "Swing", composer: "Frederick Loewe"},
...
{title: "Among My Souvenirs", style: "Ballad", composer: "Horatio Nicholls"},
...
{title: "Aren't You Glad You're You", style: "Swing", composer: "Jimmy VanHeusen"},
...
{title: "Ba-lue Bolivar Ba-lues-are", style: "Swing", composer: "Thelonious Monk"},
...
{title: "Baubles, Bangles and Beads", style: "Waltz", composer: "BorodinWrightForrest"},
{title: "Be Careful It's My Heart", style: "Swing", composer: "Irving Berlin"},
...
{title: "Bess You Is My Woman", style: "Ballad", composer: "George Gershwin"},
{title: "Bessie's Blues", style: "Swing", composer: "John Coltrane"},
{title: "Best Is Yet To Come (Page 1), The", style: "Swing", composer: "Cy Coleman"},
{title: "Best Is Yet To Come (Page 2), The", style: "Swing", composer: "Cy Coleman"},
{title: "Best Thing For You Is Me, The", style: "Swing", composer: "Irving Berlin"},
{title: "Best Things In Life Are Free, The", style: "Swing", composer: "DeSylvaBrownHenderson"},
{title: "Better Days Ahead", style: "Latin", composer: "Pat Metheny"},
{title: "Better Than Anything", style: "Waltz", composer: "LoughboroughWheat"},
{title: "Between The Devil And The Deep Blue Sea", style: "Swing", composer: "Harold Arlen"},
{title: "Bewitched", style: "Ballad", composer: "Richard Rodgers"},
{title: "Beyond The Blue Horizon", style: "Swing", composer: "WhitingHarding"},
...
{title: "Birth Of The Blues, The", style: "Swing", composer: "Ray Henderson"},
...
{title: "Blue (And Broken Hearted)", style: "Swing", composer: "LeslieHandmanClarke"},
{title: "Blue And Sentimental", style: "Ballad", composer: "LivingstoneDavidBasie"},
...
{title: "Blue In Green", style: "Ballad", composer: "Miles Davis, Bill Evans"},
...
{title: "Blue Turning Grey Over You", style: "Swing", composer: "Fats Waller"},
...
{title: "Brazil (Aquarela Do Brasil)", style: "Samba", composer: "Ary Barroso"},
...
{title: "Brother Can You Spare A Dime", style: "Swing", composer: "YarburgGorney"},
...
{title: "Call Me Irresponsible", style: "Swing", composer: "Jimmy VanHeusen"},
{title: "Can't Help Lovin' Dat Man", style: "Swing", composer: "Jerome Kern"},
...
{title: "Chega De Saudade (No More Blues)", style: "Bossa", composer: "AntonioCarlos Jobim"},
...
{title: "Close Enough For Love", style: "Ballad", composer: "MandelWilliams"},
{title: "Close Your Eyes", style: "Swing", composer: "Bernice Petkere"},
{title: "Come Back To Me", style: "Swing", composer: "Alan Lerner, Burton Lane"},
{title: "Come Fly With Me", style: "Swing", composer: "Jimmy VanHeusen"},
{title: "Come Rain Or Come Shine", style: "Swing", composer: "Harold Arlen"},
...
{title: "Conference Of The Birds", style: "Even 8ths", composer: "Dave Holland"},
{title: "Confessin' (That I Love You)", style: "Swing", composer: "DaughertyNeibergReynolds"},
...
{title: "Crepuscule With Nellie", style: "Ballad", composer: "Thelonious Monk"},
...
{title: "Dancing On The Ceiling", style: "Ballad", composer: "Richard Rodgers"},
...
{title: "Days And Nights Waiting", style: "Even 8ths", composer: "Keith Jarrett"},
{title: "Days Of Wine And Roses", style: "Swing", composer: "Henry Mancini"},
...
{title: "Desafinado (Original)", style: "Bossa", composer: "AntonioCarlos Jobim"},
...
{title: "Do Nothin' Til You Hear From Me", style: "Swing", composer: "Duke Ellington"},
{title: "Do You Know What It Means?", style: "Swing", composer: "Louis Alter"},
...
{title: "Don't Get Around Much Anymore", style: "Swing", composer: "Duke Ellington"},
{title: "Don't Go To Strangers", style: "Ballad", composer: "KentMasonEvans"},
{title: "Don't Know Why", style: "Ballad", composer: "Jesse Harris"},
{title: "Don't Misunderstand", style: "Swing", composer: "Gordon Parks"},
{title: "Don't Take Your Love From Me", style: "Ballad", composer: "Henry Nemo"},
...
{title: "Dream A Little Dream Of Me", style: "Ballad", composer: "SchwendtAndreKahn"},
...
{title: "End Of A Love Affair, The", style: "Ballad", composer: "Edward Redding"},
{title: "Epistrophy", style: "Swing", composer: "Thelonious Monk, Kenny Clarke"},
...
{title: "Ev'ry Time We Say Goodbye", style: "Ballad", composer: "Cole Porter"},
{title: "Everybody's Song But My Own", style: "Waltz", composer: "Kenny Wheeler"},
{title: "Everything Happens To Me", style: "Ballad", composer: "Matt Dennis"},
{title: "Everything I Have Is Yours", style: "Ballad", composer: "Burton Lane"},
{title: "Everything I Love", style: "Swing", composer: "Cole Porter"},
{title: "Everything I've Got Belongs To You", style: "Swing", composer: "RodgersHart"},
...
{title: "Falling In Love Again", style: "Waltz", composer: "Frederick Hollander"},
{title: "Falling In Love With Love", style: "Waltz", composer: "Richard Rodgers"},
{title: "Fantasy in D (or Ugetsu)", style: "Swing", composer: "Freddie Hubbard"},
...
{title: "Feel Like Makin' Love", style: "Rock", composer: "Eugene McDaniels"},
...
{title: "Flower Is A Lovesome Thing, A", style: "Ballad", composer: "Billy Strayhorn"},
...
{title: "Folks Who Live On The Hill, The", style: "Ballad", composer: "Jerome Kern"},
...
{title: "For Heaven's Sake", style: "Ballad", composer: "EdwardsMeyerBretton"},
{title: "For Jan", style: "Waltz", composer: "Kenny Wheeler"},
{title: "For Once In My Life", style: "Swing", composer: "Orlando Murden"},
{title: "For Sentimental Reasons", style: "Swing", composer: "William Best"},
{title: "For You, For Me, For Evermore", style: "Swing", composer: "George Gershwin"},
...
{title: "Gee Baby, Ain't I Good To You", style: "Swing", composer: "Don Redman"},
...
{title: "Get Me To The Church On Time", style: "Swing", composer: "Alan Lerner"},
...
{title: "Girl From Ipanema, The", style: "Bossa", composer: "AntonioCarlos Jobim"},
...
{title: "Good Morning Heartache", style: "Ballad", composer: "DrakeFisherHigginbotham"},
{title: "Goodbye", style: "Ballad", composer: "Gordon Jenkins"},
{title: "Goodbye Pork Pie Hat", style: "Ballad", composer: "Charles Mingus"},
...
{title: "Hallelujah I Just Love Him So", style: "Swing", composer: "Ray Charles"},
{title: "Hallucinations", style: "Swing", composer: "Bud Powell"},
{title: "Happiness Is A Thing Called Joe", style: "Swing", composer: "Harold Arlen"},
{title: "Happy Little Sunbeam", style: "Swing", composer: "Russ Freeman"},
{title: "Haunted Heart", style: "Ballad", composer: "Arthur Schwartz"},
{title: "Have You Met Miss Jones?", style: "Swing", composer: "Richard Rodgers"},
...
{title: "Here's That Rainy Day", style: "Ballad", composer: "Jimmy VanHeusen"},
...
{title: "How Are Things In Glocca Morra", style: "Ballad", composer: "Burton Lane"},
...
{title: "How Long Has This Been Going On?", style: "Ballad", composer: "George Gershwin"},
...
{title: "I Can't Believe...You're In Love...", style: "Swing", composer: "Jimmy McHugh"},
{title: "I Can't Get Started", style: "Ballad", composer: "Vernon Duke"},
{title: "I Can't Give You Anything But Love", style: "Swing", composer: "Jimmy McHugh"},
{title: "I Concentrate On You", style: "Swing", composer: "Cole Porter"},
{title: "I Could Have Danced All Night", style: "Swing", composer: "Frederick Loewe"},
{title: "I Could Write A Book", style: "Swing", composer: "Richard Rodgers"},
{title: "I Cover The Waterfront", style: "Ballad", composer: "Johnny Green"},
{title: "I Cried For You", style: "Ballad", composer: "FreedArnheimLyman"},
{title: "I Didn't Know About You", style: "Ballad", composer: "Duke Ellington"},
{title: "I Didn't Know What Time It Was", style: "Swing", composer: "Richard Rodgers"},
{title: "I Don't Know Enough About You", style: "Swing", composer: "Peggy Lee"},
{title: "I Don't Want To Miss Mississippi", style: "Swing", composer: "Serger Ellis"},
{title: "I Fall In Love Too Easily", style: "Ballad", composer: "Jule Styne"},
...
{title: "I Get Along Without You", style: "Ballad", composer: "Hoagy Carmichael"},
{title: "I Got It Bad", style: "Ballad", composer: "Duke Ellington"},
{title: "I Got Rhythm", style: "Swing", composer: "George Gershwin"},
{title: "I Got The Sun In The Morning", style: "Swing", composer: "Irving Berlin"},
{title: "I Gotta Right To Sing The Blues", style: "Ballad", composer: "Harold Arlen"},
{title: "I Guess I'll Hang My Tears Out To Dry", style: "Ballad", composer: "Jule Styne"},
{title: "I Guess I'll Have To Change My Plan", style: "Ballad", composer: "Arthur Schwartz"},
...
{title: "I Hear A Rhapsody", style: "Swing", composer: "FragosBakerGasparre"},
{title: "I Hear Music", style: "Swing", composer: "Burton Lane"},
{title: "I Left My Heart In San Francisco", style: "Ballad", composer: "George Cory"},
{title: "I Let A Song Go Out Of My Heart", style: "Swing", composer: "Duke Ellington"},
{title: "I Like The Likes Of You", style: "Swing", composer: "Vernon Duke"},
{title: "I Love Being Here With You", style: "Swing", composer: "Bill Schluger, Peggy Lee"},
...
{title: "I Only Have Eyes For You", style: "Ballad", composer: "Harry Warren"},
...
{title: "I See Your Face Before Me", style: "Ballad", composer: "Arthur Schwartz"},
...
{title: "I Thought About You", style: "Ballad", composer: "Jimmy VanHeusen"},
{title: "I Used To Be Color Blind", style: "Swing", composer: "Irving Berlin"},
{title: "I Want To Be Happy", style: "Swing", composer: "Vincent Youmans"},
{title: "I Want To Talk About You", style: "Ballad", composer: "Billy Eckstine"},
{title: "I Was Doing All Right", style: "Swing", composer: "George Gershwin"},
{title: "I Will Wait For You", style: "Swing", composer: "Michel Legrand"},
{title: "I Wish I Knew", style: "Ballad", composer: "Harry Warren"},
{title: "I Wish I Knew How It Would Feel To Be Free", style: "Even 8ths", composer: "Billy Taylor"},
{title: "I Wish I Were In Love Again", style: "Swing", composer: "Richard Rodgers"},
...
{title: "I'll Get By (As Long As I Have You)", style: "Swing", composer: "AhlertTurk"},
{title: "I'll Never Be The Same", style: "Swing", composer: "KhanMalneckSignorelli"},
{title: "I'll Only Miss Her When I Think Of Her", style: "Swing", composer: "CahnVanHeusen"},
...
{title: "I'm A Fool To Want You", style: "Ballad", composer: "HerronSinatraWolf"},
{title: "I'm All Smiles", style: "Waltz", composer: "LeonardMartin"},
{title: "I'm Always Chasing Rainbows", style: "Swing", composer: "Harry Carroll"},
{title: "I'm Beginning To See The Light", style: "Swing", composer: "HodgesJamesEllington"},
{title: "I'm Confessin' That I Love You", style: "Swing", composer: "ReynoldsDaugherty"},
{title: "I'm Getting Sentimental Over You", style: "Swing", composer: "George Bassman"},
{title: "I'm Glad There Is You", style: "Ballad", composer: "Jimmy Dorsey"},
{title: "I'm Gonna Sit Right Down and Write Myself A Letter", style: "Swing", composer: "Fred Ahlert"},
{title: "I'm In The Mood For Love", style: "Swing", composer: "Jimmy McHugh"},
{title: "I'm Just A Lucky So-And-So", style: "Swing", composer: "Duke Ellington"},
{title: "I'm Old Fashioned", style: "Swing", composer: "Jerome Kern"},
{title: "I'm Putting All My Eggs In One Basket", style: "Swing", composer: "Irving Berlin"},
{title: "I'm Sitting On Top Of The World", style: "Swing", composer: "LouisHendersonYoung"},
{title: "I'm Through With Love", style: "Ballad", composer: "KahnMalneckLivingston"},
{title: "I've Found A New Baby", style: "Swing", composer: "PalmerWilliams"},
{title: "I've Got A Crush On You", style: "Ballad", composer: "George Gershwin"},
{title: "I've Got My Love To Keep Me Warm", style: "Swing", composer: "Irving Berlin"},
{title: "I've Got The World On A String", style: "Swing", composer: "Harold Arlen"},
{title: "I've Got You Under My Skin", style: "Swing", composer: "Cole Porter"},
{title: "I've Grown Accustomed To Her Face", style: "Ballad", composer: "Frederick Loewe"},
{title: "I've Heard That Song Before", style: "Swing", composer: "Jule Styne"},
{title: "I've Never Been in Love Before", style: "Swing", composer: "Frank Loesser"},
{title: "I've Told Eve'ry Little Star", style: "Swing", composer: "Jerome Kern"},
{title: "Idle Moments", style: "Swing", composer: "Grant Green"},
{title: "If Ever I Would Leave You", style: "Swing", composer: "Frederick Loewe"},
{title: "If I Could Be With You", style: "Ballad", composer: "James Johnson"},
{title: "If I Didn't Care", style: "Swing", composer: "Jack Lawrence"},
{title: "If I Had You", style: "Swing", composer: "CampbellConnellyShapiro"},
{title: "If I Loved You", style: "Ballad", composer: "Richard Rodgers"},
{title: "If I Ruled The World", style: "Ballad", composer: "Leslie Bricusse"},
{title: "If I Should Lose You", style: "Swing", composer: "Ralph Rainger"},
{title: "If I Were A Bell", style: "Swing", composer: "Frank Loesser"},
{title: "If There Is Someone Lovelier", style: "Ballad", composer: "DietzSchwartz"},
{title: "If You Could See Me Now", style: "Ballad", composer: "Tadd Dameron"},
{title: "If You Ever Should Leave", style: "Swing", composer: "CahnChaplin"},
{title: "If You Never Come To Me", style: "Bossa", composer: "AntonioCarlos Jobim"},
...
{title: "In A Little Spanish Town", style: "Swing", composer: "WayneLewisYoung"},
{title: "In A Mellow Tone (In A Mellotone)", style: "Swing", composer: "Duke Ellington"},
{title: "In A Shanty In Old Shanty Town", style: "Waltz", composer: "LittleSiras"},
{title: "In Her Family", style: "Even 8ths", composer: "Pat Metheny"},
{title: "In Love In Vain", style: "Swing", composer: "Leo Robin Jerome Kern"},
{title: "In Pursuit Of The 27th Man", style: "Latin", composer: "Horace Silver"},
{title: "In The Cool, Cool, Cool Of The Evening", style: "Swing", composer: "Hoagy Carmichael"},
{title: "In The Middle Of A Kiss", style: "Swing", composer: "Sam Coslow"},
{title: "In The Still Of The Night", style: "Swing", composer: "Cole Porter"},
{title: "In The Wee Small Hours Of The Morning", style: "Ballad", composer: "MannHilliard"},
{title: "In Walked Bud", style: "Swing", composer: "Thelonious Monk"},
{title: "In Your Own Sweet Way", style: "Swing", composer: "Dave Brubeck"},
{title: "In a Sentimental Mood", style: "Ballad", composer: "Duke Ellington"},
{title: "Indian Summer", style: "Swing", composer: "VictorAldubinHerbert"},
{title: "Indiana (Back Home Again In)", style: "Swing", composer: "James Hanley"},
...
{title: "Is You Is Or Is You Ain't (Ma' Baby)", style: "Swing", composer: "AustinJordan"},
{title: "Isfahan", style: "Swing", composer: "StrayhornEllington"},
{title: "Isn't It A Lovely Day (To Be Caught In The Rain)", style: "Swing", composer: "Irving Berlin"},
...
{title: "It Ain't Necessarily So", style: "Swing", composer: "George Gershwin"},
{title: "It Could Happen To You", style: "Swing", composer: "Jimmy VanHeusen"},
{title: "It Don't Mean A Thing", style: "Swing", composer: "Duke Ellington"},
{title: "It Had To Be You", style: "Swing", composer: "Isham Jones"},
{title: "It Might As Well Be Spring", style: "Swing", composer: "Richard Rodgers"},
{title: "It Never Entered My Mind", style: "Ballad", composer: "Richard Rodgers"},
{title: "It Only Happens When I Dance With You", style: "Swing", composer: "Irving Berlin"},
{title: "It Was So Good While It Lasted", style: "Swing", composer: "PollAckers"},
{title: "It's A Big Wide Wonderful World", style: "Waltz", composer: "John Rox"},
...
{title: "It's A Lovely Day Today", style: "Swing", composer: "Irving Berlin"},
{title: "It's A Raggy Waltz", style: "Waltz", composer: "Dave Brubeck"},
{title: "It's All Right With Me", style: "Swing", composer: "Cole Porter"},
{title: "It's Been A Long Long Time", style: "Ballad", composer: "Jule Styne"},
{title: "It's De-lovely", style: "Swing", composer: "Cole Porter"},
{title: "It's Easy To Remember", style: "Ballad", composer: "Richard Rodgers"},
...
{title: "It's The Talk Of The Town", style: "Ballad", composer: "Jerry Livingston"},
...
{title: "Jumpin With Symphony Sid", style: "Swing", composer: "Lester Young"},
...
{title: "Just One Of Those Things", style: "Swing", composer: "Cole Porter"},
{title: "Just Squeeze Me", style: "Swing", composer: "Duke Ellington"},
{title: "Just You, Just Me", style: "Swing", composer: "Jesse Greer"},
{title: "Keepin' Myself For You", style: "Ballad", composer: "Vincent Youmans"},
...
{title: "Kiss To Build A Dream On, A", style: "Swing", composer: "KalmarRubyHammerstein"},
...
{title: "Lady is a Tramp, The", style: "Swing", composer: "Richard Rodgers"},
{title: "Lady's In Love With You, The", style: "Swing", composer: "Burton Lane"},
...
{title: "Last Night When We Were Young", style: "Ballad", composer: "Harold Arlen"},
{title: "Last Time I Saw Paris, The", style: "Swing", composer: "Henry Mancini"},
...
{title: "Let's Call The Whole Thing Off", style: "Swing", composer: "George Gershwin"},
{title: "Let's Call This", style: "Swing", composer: "Thelonious Monk"},
{title: "Let's Cool One", style: "Swing", composer: "Thelonious Monk"},
{title: "Let's Do It (Let's Fall In Love)", style: "Swing", composer: "Cole Porter"},
{title: "Let's Face The Music And Dance", style: "Swing", composer: "Irving Berlin"},
{title: "Let's Fall In Love", style: "Swing", composer: "Harold Arlen"},
{title: "Let's Get Away From It All", style: "Swing", composer: "DennisAdair"},
...
{title: "Like A Lover", style: "Bossa", composer: "Dori CaymmiNelson Motta"},
{title: "Like Someone In Love", style: "Swing", composer: "Jimmy VanHeusen"},
...
{title: "Little Boat (O Barquinho)", style: "Bossa", composer: "Roberto Menescal"},
...
{title: "Little Peace In C For You", style: "Swing", composer: "Michel Petrucciani"},
{title: "Little Rootie Tootie", style: "Swing", composer: "Thelonious Monk"},
{title: "Little Sunflower", style: "Even 8ths", composer: "Freddie Hubbard"},
...
{title: "Lone Jack (Page 2 - Solos)", style: "Samba", composer: "Pat Metheny"},
...
{title: "Look For The Silver Lining", style: "Swing", composer: "Jerome Kern"},
...
{title: "Lotus Eaters Bittersweet", style: "Swing", composer: "Billy Strayhorn"},
{title: "Love For Sale", style: "Swing", composer: "Cole Porter"},
{title: "Love Is Just Around The Corner", style: "Swing", composer: "Lewis Gensler"},
{title: "Love Me Or Leave Me", style: "Swing", composer: "Walter Donaldson"},
{title: "Love Nest, The", style: "Swing", composer: "Louis Hirsch"},
{title: "Love Walked In", style: "Swing", composer: "George Gershwin"},
{title: "Lovely Way To Spend An Evening, A", style: "Ballad", composer: "Jimmy McHugh"},
{title: "Lover", style: "Swing", composer: "Richard Rodgers"},
{title: "Lover Man", style: "Ballad", composer: "DavisRamirezSherman"},
{title: "Lover, Come Back To Me", style: "Swing", composer: "Sigmund Romberg"},
...
{title: "Lullaby Of The Leaves", style: "Swing", composer: "Bernice Petkere"},
...
{title: "Manha De Carnaval (Black Orpheus)", style: "Bossa", composer: "Luiz Bonfa"},
{title: "Manhattan", style: "Swing", composer: "Richard Rodgers"},
{title: "Manoir De Mes Rêves (Django's Castle)", style: "Swing", composer: "Django Reinhardt"},
{title: "Manteca", style: "Latin", composer: "Dizzy Gillespie"},
{title: "Mas Que Nada", style: "Latin", composer: "Jorge Ben"},
{title: "Masquerade Is Over, The", style: "Ballad", composer: "Allie Wrubel"},
{title: "Maybe I Should Change My Ways", style: "Ballad", composer: "Duke Ellington"},
...
{title: "Meaning Of The Blues, The", style: "Even 8ths", composer: "WorthTroup"},
{title: "Meditation", style: "Bossa", composer: "AntonioCarlos Jobim"},
{title: "Memories Of Tomorrow", style: "Even 8ths", composer: "Keith Jarrett"},
...
{title: "Moonlight Becomes You", style: "Ballad", composer: "Jimmy VanHeusen"},
{title: "Moonlight In Vermont", style: "Ballad", composer: "Karl Suessdorf"},
...
{title: "My Baby Just Cares For Me", style: "Swing", composer: "Walter Donaldson"},
...
{title: "My Heart Belongs To Daddy", style: "Swing", composer: "Cole Porter"},
{title: "My Heart Stood Still", style: "Swing", composer: "Richard Rodgers"},
{title: "My Ideal", style: "Ballad", composer: "Richard Whiting"},
{title: "My Last Affair", style: "Swing", composer: "Haven Johnson"},
{title: "My Little Brown Book", style: "Swing", composer: "Billy Strayhorn"},
{title: "My Little Suede Shoes", style: "Latin", composer: "Charlie Parker"},
...
{title: "Nancy (With The Laughing Face)", style: "Ballad", composer: "Jimmy VanHeusen"},
...
{title: "Nearness Of You, The", style: "Ballad", composer: "Hoagy Carmichael"},
...
{title: "Nice Work If You Can Get It", style: "Swing", composer: "George Gershwin"},
...
{title: "Night Has A Thousand Eyes, The", style: "Latin", composer: "JerryBrainin"},
{title: "Night In Tunisia, A", style: "Latin", composer: "Dizzy Gillespie"},
{title: "Night We Called It A Day, The", style: "Swing", composer: "Matt Dennis"},
{title: "Nightingale Sang In Berkeley Square, A", style: "Ballad", composer: "Manning Sherwin"},
...
{title: "Nostalgia In Times Square", style: "Swing", composer: "Charles Mingus"},
...
{title: "Oh, What A Beautiful Mornin'", style: "Waltz", composer: "Richard Rodgers"},
...
{title: "On A Slow Boat To China", style: "Swing", composer: "Frank Loesser"},
{title: "On Broadway", style: "Even 8ths", composer: "MannWeilStollerLeiber"},
{title: "On Green Dolphin Street", style: "Swing", composer: "Bronislau Kaper"},
{title: "On The Street Where You Live", style: "Swing", composer: "Frederick Loewe"},
{title: "On The Sunny Side Of The Street", style: "Swing", composer: "Jimmy McHugh"},
...
{title: "One I Love (Belongs To Somebody Else), The", style: "Swing", composer: "Isham Jones"},
...
{title: "Our Love is Here to Stay", style: "Swing", composer: "George Gershwin"},
{title: "Out Of Nowhere", style: "Swing", composer: "Johnny Green"},
{title: "Out Of This World", style: "Latin", composer: "Harold Arlen"},
{title: "Over The Rainbow (Somewhere)", style: "Ballad", composer: "Harold Arlen"},
...
{title: "People Will Say We're In Love", style: "Swing", composer: "Richard Rodgers"},
{title: "Perdido", style: "Latin", composer: "Juan Tizol"},
{title: "Perhaps", style: "Swing", composer: "Charlie Parker"},
{title: "Perhaps, Perhaps, Perhaps", style: "Latin", composer: "FarresDavis"},
...
{title: "Polkadots And Moonbeams", style: "Ballad", composer: "Jimmy VanHeusen"},
...
{title: "Pretty Girl Is Like A Melody, A", style: "Swing", composer: "Irving Berlin"},
...
{title: "Quasimodo (Blowing Changes)", style: "Swing", composer: "Charlie Parker"},
...
{title: "Rainbow Connection, The", style: "Waltz", composer: "WilliamsAscher"},
...
{title: "Relaxin' At Camarillo", style: "Swing", composer: "Charlie Parker"},
...
{title: "Saga Of Harrison Crabfeathers, The", style: "Waltz", composer: "Steve Kuhn"},
...
{title: "San Francisco Holiday", style: "Swing", composer: "Thelonious Monk"},
...
{title: "Say It (Over And Over Again)", style: "Ballad", composer: "Frank Loesser"},
{title: "Say the Brother's Name", style: "Even 8ths", composer: "Pat Metheny"},
{title: "Scene", style: "Swing", composer: "Tom Harrell"},
{title: "Scotch And Soda", style: "Swing", composer: "Dave Guard"},
{title: "Scrapple From The Apple", style: "Swing", composer: "Charlie Parker"},
{title: "Sea Journey", style: "Latin", composer: "Chick Corea"},
{title: "Second Star To The Right, The", style: "Swing", composer: "Sammy Fain"},
{title: "Second Time Around, The", style: "Swing", composer: "Jimmy VanHeusen"},
...
{title: "Serenade To A Soul Sister", style: "Waltz", composer: "Horace Silver"},
...
{title: "Seven Steps To Heaven", style: "Swing", composer: "Victor Feldman"},
{title: "Shadow Of Your Smile, The", style: "Bossa", composer: "Johnny Mandel"},
{title: "Shaw 'Nuff", style: "Swing", composer: "Charlie Parker"},
{title: "She's Funny That Way", style: "Ballad", composer: "Charles Daniels"},
...
{title: "Smoke Gets In Your Eyes", style: "Ballad", composer: "Jerome Kern"},
...
{title: "Softly, As In A Morning Sunrise", style: "Swing", composer: "Sigmund Romberg"},
{title: "Solar", style: "Swing", composer: "Miles Davis"},
{title: "Solitude", style: "Ballad", composer: "Duke Ellington"},
{title: "Some Enchanted Evening", style: "Ballad", composer: "Richard Rodgers"},
...
{title: "Someday (You'll Be Sorry)", style: "Swing", composer: "Louis Armstrong"},
{title: "Someday My Prince Will Come", style: "Waltz", composer: "Frank Churchill"},
{title: "Someday You'll Be Sorry", style: "Swing", composer: "Louis Armstrong"},
{title: "Someone To Watch Over Me", style: "Ballad", composer: "George Gershwin"},
...
{title: "Sound For Sore Ears, A", style: "Even 8ths", composer: "Jimmy Heath"},
...
{title: "Spring Can Really Hang You Up The Most", style: "Ballad", composer: "Tommy Wolf"},
...
{title: "Star-Crossed Lovers", style: "Ballad", composer: "StrayhornEllington"},
{title: "Stars Fell On Alabama", style: "Ballad", composer: "Frank Perkins"},
{title: "Stella By Starlight", style: "Swing", composer: "Victor Young"},
{title: "Stolen Moments", style: "Swing", composer: "Oliver Nelson"},
{title: "Stompin' At The Savoy", style: "Swing", composer: "WebbGoodmanSampson"},
...
{title: "Straighten Up And Fly Right", style: "Swing", composer: "ColeMills"},
{title: "Strangers In The Night", style: "Swing", composer: "Bert Kaempfert"},
...
{title: "Struttin' With Some Barbecue", style: "Swing", composer: "Lillian Armstrong"},
{title: "Subconscious Lee", style: "Swing", composer: "Lee Konitz"},
{title: "Suddenly It's Spring", style: "Swing", composer: "Jimmy VanHeusen"},
{title: "Sugar", style: "Swing", composer: "Stanley Turrentine"},
{title: "Summer Band Camp", style: "Even 8ths", composer: "Mick Goodrick"},
{title: "Summer In Central Park", style: "Waltz", composer: "Horace Silver"},
...
{title: "Sunday Kind Of Love, A", style: "Ballad", composer: "BellePrimaLeonardRhodes"},
{title: "Sunny", style: "Rock", composer: "Bobby Hebb"},
{title: "Sunshower", style: "Bossa", composer: "Kenny Barron"},
{title: "Surrey With The Fringe On The Top", style: "Swing", composer: "Richard Rodgers"},
{title: "Sway", style: "Latin", composer: "RuizGimbel"},
{title: "Sweeping Up", style: "Ballad", composer: "Steve Swallow"},
{title: "Sweet And Lovely", style: "Swing", composer: "ArnheimDanielsTobias"},
{title: "Sweet Georgia Bright", style: "Swing", composer: "Charles Lloyd"},
{title: "Sweet Georgia Brown", style: "Swing", composer: "PinkardCaseyBernie"},
{title: "Sweet Lorraine", style: "Swing", composer: "Cliff Burwell"},
{title: "Sweet Sue, Just You", style: "Swing", composer: "HarrisYoung"},
{title: "Sweetest Sounds, The", style: "Swing", composer: "Richard Rodgers"},
{title: "Swinging At The Haven", style: "Swing", composer: "Ellis Marsalis"},
{title: "Swinging Shepherd Blues, The", style: "Swing", composer: "KoffmanRobertsJacobson"},
...
{title: "Tell me a bedtime story", style: "Funk", composer: "Herbie Hancock"},
...
{title: "That Old Devil Called Love", style: "Swing", composer: "Doris Fisher"},
...
{title: "There Is No Greater Love", style: "Swing", composer: "Isham Jones"},
{title: "There Will Never Be Another You", style: "Swing", composer: "Harry Warren"},
{title: "There'll Be Some Changes Made", style: "Swing", composer: "Benton Overstreet"},
{title: "There's A Lull In My Life", style: "Ballad", composer: "Harry Revel"},
{title: "There's A Small Hotel", style: "Swing", composer: "Richard Rodgers"},
...
{title: "They Can't Take That Away From Me", style: "Swing", composer: "George Gershwin"},
{title: "They Didn't Believe Me", style: "Swing", composer: "Jerome Kern"},
{title: "They Say", style: "Swing", composer: "HeymanMannWeiss"},
{title: "They Say It's Wonderful", style: "Swing", composer: "Irving Berlin"},
{title: "Things Ain't What They Used To Be", style: "Swing", composer: "Duke Ellington"},
{title: "Things We Did Last Summer, The", style: "Swing", composer: "CahnStyne"},
{title: "Think Of One", style: "Swing", composer: "Thelonious Monk"},
{title: "This Can't Be Love", style: "Swing", composer: "Richard Rodgers"},
{title: "This Could Be The Start Of Something Good", style: "Swing", composer: "Steve Allen"},
...
{title: "This Time The Dream's On Me", style: "Swing", composer: "Harold Arlen"},
...
{title: "Tonight I Shall Sleep", style: "Ballad", composer: "EllingtonMercer"},
{title: "Tonight You Belong To Me", style: "Swing", composer: "RoseDavid"},
{title: "Too Close For Comfort", style: "Swing", composer: "BockWeissHolofcener"},
{title: "Too Marvelous For Words", style: "Swing", composer: "Richard Whiting"},
{title: "Too Young", style: "Ballad", composer: "LippmanDee"},
{title: "Too Young To Go Steady", style: "Ballad", composer: "Jimmy McHugh"},
...
{title: "Try A Little Tenderness", style: "Ballad", composer: "Harry Woods"},
...
{title: "Under A Blanket Of Blue", style: "Swing", composer: "Jerry Livingston"},
...
{title: "Upper Manhattan Medical Group", style: "Swing", composer: "Billy Strayhorn"},
...
{title: "Wait Till You See Her", style: "Swing", composer: "Richard Rodgers"},
{title: "Walk Tall", style: "Funk", composer: "Cannonball Adderley"},
{title: "Walkin'", style: "Swing", composer: "Miles Davis"},
{title: "Walkin' My Baby Back Home", style: "Swing", composer: "AhlertTurk"},
...
{title: "Way You Look Tonight, The", style: "Swing", composer: "Jerome Kern"},
...
{title: "We'll Be Together Again", style: "Ballad", composer: "Carl Fisher"},
...
{title: "What A Difference A Day Made", style: "Ballad", composer: "Maria Grever"},
{title: "What A Little Moonlight Can Do", style: "Swing", composer: "Harry Woods"},
{title: "What A Wonderful World", style: "Ballad", composer: "WeissThiele"},
{title: "What Are You Doing New Years", style: "Ballad", composer: "Frank Loesser"},
{title: "What Are You Doing The Rest Of Your Life?", style: "Ballad", composer: "Michel Legrand"},
{title: "What Is This Thing Called Love", style: "Swing", composer: "Cole Porter"},
...
{title: "When It's Sleepy Time Down South", style: "Swing", composer: "Traditional"},
...
{title: "When The Saints Go Marching In", style: "Swing", composer: "Traditional"},
{title: "When The Sun Comes Out", style: "Ballad", composer: "Harold Arlen"},
{title: "When You Wish Upon A Star", style: "Ballad", composer: "Leigh Harline"},
{title: "When You're Smilin'", style: "Swing", composer: "Shay  Fisher  Goodwin"},
...
{title: "Why Don't You Do Right?", style: "Swing", composer: "KansasJoe McCoy"},
...
{title: "With A Song In My Heart", style: "Swing", composer: "Richard Rodgers"},
{title: "With The Wind And The Rain In Hair", style: "Swing", composer: "Clare Edwards"},
{title: "Without A Song", style: "Swing", composer: "Vincent Youmans"},
{title: "Wives And Lovers", style: "Waltz", composer: "Burt Bacharach"},
{title: "Wonderful Day Like Today, A", style: "Swing", composer: "BricusseNewley"},
...
{title: "Wouldn't It Be Loverly", style: "Swing", composer: "Frederick Loewe"},
{title: "Wow", style: "Swing", composer: "Lennie Tristano"},
{title: "Wrap Your Troubles In Dreams", style: "Swing", composer: "Harry Barris"},
{title: "Yardbird Suite", style: "Swing", composer: "Charlie Parker"},
{title: "Yes And No", style: "Swing", composer: "Wayne Shorter"},
{title: "Yesterday's Gardenias", style: "Swing", composer: "Robertson Mysels"},
{title: "Yesterdays", style: "Swing", composer: "Jerome Kern"},
{title: "You And The Night And The Music", style: "Swing", composer: "Arthur Schwartz"},
{title: "You Are Too Beautiful", style: "Ballad", composer: "Richard Rodgers"},
{title: "You Better Go Now", style: "Swing", composer: "ReichnerGraham"},
{title: "You Brought A New Kind Of Love", style: "Swing", composer: "FainKavalNorman"},
{title: "You Can Depend On Me", style: "Swing", composer: "CarpenterDunlapHines"},
{title: "You Do Something To Me", style: "Swing", composer: "Cole Porter"},
{title: "You Don't Know What Love Is", style: "Ballad", composer: "RayeDePaul"},
{title: "You Go To My Head", style: "Ballad", composer: "Fred Coots"},
{title: "You Keep Coming Back Like A Song", style: "Swing", composer: "Irving Berlin"},
{title: "You Made Me Love You", style: "Swing", composer: "James Monaco"},
{title: "You Make Me Feel So Young", style: "Swing", composer: "Josef Myrow"},
{title: "You Must Believe In Spring", style: "Ballad", composer: "Michel Legrand"},
{title: "You Stepped Out Of A Dream", style: "Swing", composer: "NacioHerbBrown"},
{title: "You Took Advantage Of Me", style: "Swing", composer: "Richard Rodgers"},
{title: "You Turned The Tables on Me", style: "Swing", composer: "Louis Alter"},
{title: "You Won't Forget Me", style: "Ballad", composer: "GoellSpielman"},
{title: "You'd Be So Nice To Come Home To", style: "Swing", composer: "Cole Porter"},
...
{title: "You're Nobody Till Somebody Loves You", style: "Swing", composer: "MorganStockCavanaugh"},
...
{title: "Zing Went The Strings Of My Heart", style: "Swing", composer: "James Hanley"},
{title: "Zingaro (Retrato Em Branco E Preto)", style: "Bossa", composer: "AntonioCarlos Jobim"},
